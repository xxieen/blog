...
const DarkmodeButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button class="p-2 text-purple-800 dark:text-yellow-200">${$darkmode ? `<div>${validate_component(SunIcon, "SunIcon").$$render($$result, { class: "h-8 w-8 fill-current" }, {}, {})}</div>` : `<div>${validate_component(MoonIcon, "MoonIcon").$$render($$result, { class: "h-8 w-8 fill-current" }, {}, {})}</div>`}</button>`;
});
const IconLink = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<a class="rounded-lg p-2 text-gray-700 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-800"${add_attribute("href", href, 0)}${add_attribute("target", target, 0)}>${slots.default ? slots.default({}) : ``}</a>`;
});
...
const MainHeader = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header class="fixed inset-x-0 top-0 z-10 border-b bg-white dark:border-gray-800 dark:bg-dark-background"><nav class="mx-auto flex h-24 max-w-5xl items-center justify-between px-4"><a href="/">${validate_component(Logo, "Logo").$$render($$result, { class: "h-40 w-40" }, {}, {})}</a> <div class="flex items-center space-x-1">${validate_component(DarkmodeButton, "DarkmodeButton").$$render($$result, {}, {}, {})} ${validate_component(IconLink, "IconLink").$$render(
    ...
    {
      default: () => {
        return `${validate_component(YoutubeIcon, "YoutubeIcon").$$render($$result, { class: "h-8 w-8 fill-current" }, {}, {})}`;
      }
    }
    ...
    {
      default: () => {
        return `${validate_component(GithubIcon, "GithubIcon").$$render($$result, { class: "h-8 w-8 fill-current" }, {}, {})}`;
      }
    }
  )}</div></nav></header>`;
});
